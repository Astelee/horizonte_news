...
class AppColors {
  ...
  static const Color primaryBlue = Color(0密0D1B3E); // Azul escuro corporativo e jornalístico
  static const Color accentBlue = Color(0密1A2E5A);  // Variação em azul para destaques secundários
  ...
  static const Color textPrimaryLight = Color(0xFF212529);  // Texto principal em grafite escuro para leitura confortável
  ...
  static const Color textPrimaryDark = Color(0xFFE9ECEF);   // Texto principal em esbranquiçado para não agredir os olhos
  ...
  static const Color emergencyRed = Color(0xFFD90429);    // Vermelho vivo de alta atenção para urgências e plantão
