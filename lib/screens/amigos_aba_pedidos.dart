...
class MenuContextoAmigo extends StatelessWidget {
  ...
  // ─────────────────────────────────────────────────────────────────
  // LIMPAR CONVERSA — agora implementado de verdade.
  // Antes esse botão só fechava o menu sem fazer nada. Agora ele:
  // 1. Apaga as mensagens (para mim)
  // 2. Limpa o resumo mostrado no card da lista
  // 3. Esconde a conversa da minha lista (hiddenFor)
  // A conversa volta a aparecer sozinha quando eu ou o amigo
  // mandarmos uma mensagem nova, ou se eu abrir o chat de novo
  // pelo perfil do amigo.
  // ─────────────────────────────────────────────────────────────────
