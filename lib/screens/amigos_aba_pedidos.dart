...
class AbaPedidos extends StatelessWidget {
  ...
  const AbaPedidos({Key? key, required this.myUid, required this.db})
      : super(key: key);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Row(
              children: [
                AmigoAvatar(friend: widget.remetente),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(widget.remetente.displayName,
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 15,
                              fontWeight: FontWeight.w700)),
                      Text('@${widget.remetente.username}',
                          style: TextStyle(
                      ...
                      Row(
                        children: [
                          NivelBadge(level: widget.remetente.level),
                          const SizedBox(width: 6),
                          Text('${widget.remetente.totalXp} XP',
                              style: const TextStyle(
